  ...
  return (
    ...
    >
      ...
      {state === "show" && (
        <button
          onClick={() => {
            // Swallowed on purpose: the banner has always said "sent" either
            // way, and now that the call can actually reject there has to be
            // something here to catch it.
            http("/api/auth/resend-verification", { method: "POST" })
              .catch(() => {})
