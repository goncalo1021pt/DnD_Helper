 ...
 */
function AtTheDoorSection({ campaign }: { campaign: Campaign }) {
 ...
 */
function TheVeilSection({ campaign }: { campaign: Campaign }) {
  const { data: characters } = useCharacters(campaign.id);
 ...
 * the table.
 */
function DisbandSection({ campaign }: { campaign: Campaign }) {
